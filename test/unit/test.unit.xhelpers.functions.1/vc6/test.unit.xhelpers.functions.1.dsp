# Microsoft Developer Studio Project File - Name="test.unit.xhelpers.functions.1" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.unit.xhelpers.functions.1 - Win32 Unicode Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.unit.xhelpers.functions.1.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.unit.xhelpers.functions.1.mak" CFG="test.unit.xhelpers.functions.1 - Win32 Unicode Debug"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.unit.xhelpers.functions.1 - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.xhelpers.functions.1 - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.xhelpers.functions.1 - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.xhelpers.functions.1 - Win32 Debug Multithreaded MFC" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.xhelpers.functions.1 - Win32 Unicode Debug" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.unit.xhelpers.functions.1 - Win32 Release"
...
# ADD CPP /nologo /W3 /GX /O2 /I "../../../../include" /I "$(XTESTS_C_ROOT)/include" /I "$(PANTHEIOS_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /machine:I386 /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib"

!ELSEIF  "$(CFG)" == "test.unit.xhelpers.functions.1 - Win32 Debug"
...
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "../../../../include" /I "$(XTESTS_C_ROOT)/include" /I "$(PANTHEIOS_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib"

!ELSEIF  "$(CFG)" == "test.unit.xhelpers.functions.1 - Win32 Debug pseudoUNIX"
...
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD BASE CPP /nologo /W3 /Gm /GX /ZI /Od /I "../../../../include" /I "$(XTESTS_C_ROOT)/include" /I "$(PANTHEIOS_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /YX /FD /GZ /c
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "../../../../include" /I "$(XTESTS_C_ROOT)/include" /I "$(PANTHEIOS_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /I "$(UNIXEM)/include" /D "UNIX" /D "_DEBUG" /D "_WINDOWS" /D "_STLSOFT_FORCE_ANY_COMPILER" /YX /FD /GZ /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib"
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(UNIXEM)/lib"

!ELSEIF  "$(CFG)" == "test.unit.xhelpers.functions.1 - Win32 Debug Multithreaded MFC"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "DebugMtMfc"
# PROP BASE Intermediate_Dir "DebugMtMfc"
# PROP BASE Ignore_Export_Lib 0
# PROP BASE Target_Dir ""
# PROP Use_MFC 2
# PROP Use_Debug_Libraries 1
# PROP Output_Dir "DebugMtMfc"
# PROP Intermediate_Dir "DebugMtMfc"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD BASE CPP /nologo /W3 /Gm /GX /ZI /Od /I "../../../../include" /I "$(XTESTS_C_ROOT)/include" /I "$(PANTHEIOS_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /YX /FD /GZ /c
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /I "../../../../include" /I "$(XTESTS_C_ROOT)/include" /I "$(PANTHEIOS_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /YX /FD /GZ /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0xc09 /d "_DEBUG"
...
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib"
# ADD LINK32 /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib"

!ELSEIF  "$(CFG)" == "test.unit.xhelpers.functions.1 - Win32 Unicode Debug"
...
# PROP Target_Dir ""
# ADD BASE CPP /nologo /W3 /Gm /GX /Zi /Od /I "../../../../include" /I "$(XTESTS_C_ROOT)/include" /I "$(PANTHEIOS_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /YX /FD /GZ /c
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "../../../../include" /I "$(XTESTS_C_ROOT)/include" /I "$(PANTHEIOS_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_UNICODE" /D "UNICODE" /YX /FD /GZ /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0xc09 /d "_DEBUG"
# ADD RSC /l 0xc09 /d "_DEBUG"
...
# Name "test.unit.xhelpers.functions.1 - Win32 Release"
# Name "test.unit.xhelpers.functions.1 - Win32 Debug"
# Name "test.unit.xhelpers.functions.1 - Win32 Debug pseudoUNIX"
# Name "test.unit.xhelpers.functions.1 - Win32 Debug Multithreaded MFC"
# Name "test.unit.xhelpers.functions.1 - Win32 Unicode Debug"
...
SOURCE=..\test.unit.xhelpers.functions.1.cpp
# End Source File
# End Group
...
SOURCE="$(STLSOFT)\include\mfcstl\shims\access\string\cstring.hpp"
# End Source File
# Begin Source File

SOURCE="$(STLSOFT)\include\mfcstl\shims\access\string\cwnd.hpp"
# End Source File
# Begin Source File
...
SOURCE="$(STLSOFT)\include\mfcstl\shims\access\string.hpp"
# End Source File
# End Group
...
# PROP Default_Filter ""
# Begin Group "Pantheios::Extras::xHelpers"

# PROP Default_Filter ""
# Begin Source File

SOURCE="$(PANTHEIOS_EXTRAS_XHELPERS_ROOT)\include\pantheios\extras\xhelpers\internal\common.h"
# End Source File
# Begin Source File

SOURCE="$(PANTHEIOS_EXTRAS_XHELPERS_ROOT)\include\pantheios\extras\xhelpers\internal\common.hpp"
# End Source File
# Begin Source File

SOURCE="$(PANTHEIOS_EXTRAS_XHELPERS_ROOT)\include\pantheios\extras\xhelpers\invoke.hpp"
# End Source File
# Begin Source File

SOURCE="$(PANTHEIOS_EXTRAS_XHELPERS_ROOT)\include\pantheios\extras\xhelpers\internal\pantheios.h"
# End Source File
# Begin Source File

SOURCE="$(PANTHEIOS_EXTRAS_XHELPERS_ROOT)\include\pantheios\extras\xhelpers\internal\stlsoft.h"
# End Source File
# Begin Source File

SOURCE="$(PANTHEIOS_EXTRAS_XHELPERS_ROOT)\include\pantheios\extras\xhelpers\custom\symbols.hpp"
# End Source File
# Begin Source File

SOURCE="$(PANTHEIOS_EXTRAS_XHELPERS_ROOT)\include\pantheios\extras\xhelpers.hpp"
# End Source File
# End Group
# End Group
# Begin Source File
